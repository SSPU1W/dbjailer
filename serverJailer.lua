						...
						TriggerEvent('modest:getCharacterFromId', tPID, function(characters)
							...
							names = characters.first_name.." "..characters.last_name
						        TriggerClientEvent("pNotify:SendNotification", -1, {
									text = "<b style = 'color:#FF0000'>State Prison</b><br/ ><br / br><b style = 'color:#00ff00'>" .. names .. " has been jailed for ".. jT / 60 .. " months for " .. reason.. "<br/ ><br / br><b style = 'color:#FF0000'>Jailing Officer: "  .. name .. "</b> ",
						            type = "success",
						            queue = "lmao",
						            timeout = 7500,
						            layout = "bottomRight"
				...
				if GetPlayerName(tPID) ~= nil then
					...
					TriggerEvent('modest:getCharacterFromId', userSource, function(character)
						TriggerEvent('modest:getCharacterFromId', tPID, function(characters)
							...
							names = characters.first_name.." "..characters.last_name
						        TriggerClientEvent("pNotify:SendNotification", -1, {
									text = "<b style = 'color:#FF0000'>State Prison</b><br/ ><br / br><b style = 'color:#00ff00'>" .. names .. " has been jailed for ".. jT / 60 .. " months for " .. reason.. " </b><br/ ><br / br><b style = 'color:#FF0000'>Jailing Officer: "  .. name .. "</b> ",
						            type = "success",
						            queue = "lmao",
						            timeout = 7500,
						            layout = "bottomRight"
				...
				if GetPlayerName(tPID) ~= nil then
					...
					TriggerEvent('modest:getCharacterFromId', userSource, function(character)
						TriggerEvent('modest:getCharacterFromId', tPID, function(characters)
							...
							names = characters.first_name.." "..characters.last_name
						        TriggerClientEvent("pNotify:SendNotification", -1, {
									text = "<b style = 'color:#FF0000'>Federal Prison</b><br/ ><br / br><b style = 'color:#00ff00'>" .. names .. " has been jailed for ".. jT / 60 .. " months for " .. reason.. " </b><br/ ><br / br><b style = 'color:#FF0000'>Jailing Officer: "  .. name .. "</b> ",
						            type = "success",
						            queue = "lmao",
						            timeout = 7500,
						            layout = "bottomRight"
